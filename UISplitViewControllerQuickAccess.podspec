...
Pod::Spec.new do |s|
  ...
  s.name         = "UISplitViewControllerQuickAccess"
  s.version      = "1.1.3"
  s.summary      = "Category for easily finding the main views in a UISplitViewController."
  ...
  s.source       = { :git => "https://github.com/HiddenJester/UISplitViewController-QuickAccess.git", :tag => "v#{s.version}" }
  ...
  s.source_files  = "UISplitViewControllerQuickAccess"
